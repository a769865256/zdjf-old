...
var lottery = {
	...
	// 开启抽奖
	_enable: function () {
		this.container.find('.btn_go').bind('click', this.beforeRoll);
	},

	// 禁用抽奖
	_disable: function () {
		this.container.find('.btn_go').unbind('click', this.beforeRoll);
	},
	...
	_roll: function () {
		...
		if (_this.options._roll) {
			_this.options._roll.call(_this);
		}
	},
