...
<body class="zoom">
<div class="find">
    <div class="header"><a class="back" href="<%=path%>/appStatic/about.action?isBack=1"></a>团队介绍</div>
	<div class="f_team">
		<img src="<%=path%>/images/front/m/team01.png" alt="">
		<img src="<%=path%>/images/front/m/team02.png" alt="">
	</div>
</div>
