		...
		<form action="" method="post" class="form form-horizontal"
			...
			<div class="row cl">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" readonly class="input-text" value=""
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" readonly class="input-text" placeholder=""
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<span class="select-box"> <select class="select" size="1"
							name="city">
								<option value="" selected>请选择婚姻状况</option>
				...
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3">出借方相关图片：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="" placeholder=""
							id="imgtxt" name="imgtxt">
					</div>
				</div>
			<div class="row cl">
