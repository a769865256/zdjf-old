		...
		<tbody>
				<c:forEach var="line"  items="${detail.dataList }">
								<tr>
									...
									<td class=""><fmt:formatNumber value="${line.pay_amount }" type="currency" pattern="￥#,##0.0#"/></td>
									<td>${line.goods_type }</td>
									<td class="">
									...
									<td class=""><fmt:formatDate value="${line.update_time }" type="both" pattern="yyyy年MM月dd日 HH点mm分ss秒" /></td>
									<td>${line.remark }</td>
								</tr>
							</c:forEach>
		</tbody>
