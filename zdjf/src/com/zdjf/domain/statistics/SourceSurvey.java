...
public class SourceSurvey implements Serializable{

	/**
	 * 资源统计
	 */
	private static final long serialVersionUID = 8211282138406753950L;
...
protected Long id;  
	...
	protected String subordinate_platform;//平台名称
	
	protected String source_name;//渠道名称
	...
	public String getSubordinate_platform() {
		return subordinate_platform;
	}

	public void setSubordinate_platform(String subordinate_platform) {
		this.subordinate_platform = subordinate_platform;
	}
