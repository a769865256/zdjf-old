...
@Service
public class ProductBuyDao extends AbstractDao implements IProductBuyDao {
	...
	public Page page(Page page, ProductBuy productBuy) {
		...
		IPageQuery pageQuery = pageQueryFactory.getPageQuery(page,"selectProductBuyPage", "selectProductBuyCount");
		return pageQuery.select(productBuy);
	}
	...
	public Page getProductBuyPageList(Page p,Map map){
		IPageQuery pageQuery = pageQueryFactory.getPageQuery(p,"selectProductBuyPageList", "selectProductBuyPageListCount");
		return pageQuery.select(map);
	}
