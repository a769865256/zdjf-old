...
@Service
public class AppReleaseDao extends AbstractDao implements IAppReleaseDao{

	
	private PageQueryFactory<PageQuery> pageQueryFactory;
	@Override
	public Page page(Page page, AppRelease appRelease) {
		IPageQuery pageQuery = pageQueryFactory.getPageQuery(page,"selectAppReleasePage", "selectAppReleaseCount");
		return pageQuery.select(appRelease);
	}
