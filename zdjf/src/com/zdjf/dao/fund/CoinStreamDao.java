...
@Service
public class CoinStreamDao extends AbstractDao implements ICoinStreamDao {

	private PageQueryFactory<PageQuery> pageQueryFactory;
	@Override
	public Page page(Page page, CoinStream coinStream) {
		IPageQuery pageQuery = pageQueryFactory.getPageQuery(page,"selectCoinStreamPage", "selectCoinStreamCount");
		return pageQuery.select(coinStream);
	}
