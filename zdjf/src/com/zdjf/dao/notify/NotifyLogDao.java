...
@Service
public class NotifyLogDao extends AbstractDao implements INotifyLogDao {

	private PageQueryFactory<PageQuery> pageQueryFactory;
	
	public Page page(Page page, NotifyLog notifyLog) {
		IPageQuery pageQuery = pageQueryFactory.getPageQuery(page,"selectNotifyLogPage", "selectNotifyLogCount");
		return pageQuery.select(notifyLog);
	}
