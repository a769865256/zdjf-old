...
@Service
public class SignDao extends AbstractDao implements ISignDao{

	
	private PageQueryFactory<PageQuery> pageQueryFactory;
	@Override
	public Page page(Page page, Sign sign) {
		IPageQuery pageQuery = pageQueryFactory.getPageQuery(page,"selectSignPage", "selectSignCount");
		return pageQuery.select(sign);
	}
