...
public class CityMapUtil {
	...
	*/
	...
	model.put("辽宁", new String[]{"沈阳","大连","葫芦岛","盘锦","本溪","抚顺","铁岭","辽阳","营口","阜新","朝阳","锦州","丹东","鞍山"});
	...
	model.put("安徽", new String[]{"合肥","巢湖","蚌埠","安庆","六安","滁州","马鞍山","阜阳","宣城","铜陵","淮北","芜湖","毫州","宿州","淮南","池州","黄山"});
    ...
    public static Object[] getProvince() {
        Map<String, String[]> map = CityMapUtil.model;// 获取省份信息保存到Map中
