...
public abstract class Assert {
	 ...
	 * 
	 * <pre class="code">
	 * 	hasLength(null)      throw exception
	 * 	hasLength("")        throw exception
	 *  hasLength(" ")       not thorw exception
	 *  hasLength("bob")     not thorw exception
	 *  hasLength("  bob  ") not thorw exception
	 * 
	 * </pre>
	 * 
	 ...
	 * 
	 * <pre class="code">
	 *  hasTest(null)      throw exception
	 *  hasTest("")        throw exception
	 *  hasTest(" ")       throw exception
	 *  hasTest("bob")     not thorw exception
	 *  hasTest("  bob  ") not thorw exception
	 * 
	 * </pre>
	 * 
